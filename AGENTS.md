# Geography and the Environment Pupil’s Book Standard Five — ADT Bundle Reference
...
**Geography and the Environment Pupil’s Book Standard Five** — This is an English-language primary school geography textbook from Tanzania, published by the Tanzania Institute of Education for Standard Five pupils, roughly equivalent to upper primary level. It introduces Tanzanian natural resources, population distribution, weather, and how weather influences production activities such as farming, fishing, mining and energy, with a strong focus on sustainability, conservation and national development. The book uses a practical, competency-based approach through activities, maps, figures, exercises and revision tasks, encouraging pupils to apply geographical knowledge to everyday life and their local environment.
...
```
GEOGRAPHY-AND-THE-ENVIRONMENT-STD-5-17.09.2025/
├── adt/                              # THE WEB APP
...
├── GEOGRAPHY-AND-THE-ENVIRONMENT-STD-5-17.09.2025.db                    # SQLite database (pipeline state)
├── GEOGRAPHY-AND-THE-ENVIRONMENT-STD-5-17.09.2025.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im002": "Turquoise book cover title panel reading “Geography and the Environment”, “Pupil’s Book” and “Standard Five”, with a purple ring overlapping the word “Five”.",
  "gl001": "accessible",
  "gl001_def": "easy to reach or use",
  "qz001_que": "Which type of natural resource can be replaced again in a short time after being used?",
  "qz001_o0": "1) Mineral resource",
  "qz001_o0_exp": "❌ Not quite. Minerals are natural resources, but many of them are non-renewable rather than quickly replaced."
}
```
...
```json
{
  "accessible": {
    ...
    "variations": ["access","accessibility"],
    "emoji": "🛣️✅"
  }
}
```
...
```json
{
  "title": "Geography and the Environment Pupil’s Book Standard Five",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which type of natural resource can be replaced again in a short time after being used?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. Minerals are natural resources, but many of them are non-renewable rather than quickly replaced." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Mineral resource</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `GEOGRAPHY-AND-THE-ENVIRONMENT-STD-5-17.09.2025.pdf` |
| Pipeline database | `GEOGRAPHY-AND-THE-ENVIRONMENT-STD-5-17.09.2025.db` (SQLite) |
